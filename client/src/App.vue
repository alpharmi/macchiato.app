<template>
  <header class="h-14 bg-[#00000020] backdrop-blur-lg drop-shadow-md flex justify-between items-center relative">
    ...
    <a href="https://ko-fi.com/alpharmi" class="bg-secondary !p-2 !px-5 brightness-150 mr-5 sm:mr-2 flex inline-image group !text-text !border-none invisible"><img class="group-hover:scale-110 transition-transform" src="/kofi.webp"><p>Buy us a Ko-Fi</p></a>
  </header>
